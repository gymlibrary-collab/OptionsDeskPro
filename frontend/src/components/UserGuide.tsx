  ...
  return (
    <div style={{ maxWidth: '820px', margin: '0 auto', fontFamily: font }}>
      ...
      <Section title="Strategy Scanner">
        ...
        <Sub>
          <Term term="IVR (IV Rank)">Where today's implied volatility sits relative to the past 52 weeks, on a 0–100 scale. IVR 80 means options are more expensive than 80% of all days in the past year. Higher = better for sellers. The coloured dot next to the IVR bar shows data reliability — <strong style={{color:'#38bdf8'}}>blue</strong> or <strong style={{color:'#34d399'}}>teal</strong> means the IVR is from a primary source (most reliable); <strong style={{color:'#facc15'}}>yellow</strong> or <strong style={{color:'#9ca3af'}}>grey</strong> means it is from a secondary source (approximated). <strong>If the dot is not blue or teal, trade with caution — the IV rank may not reflect true market conditions.</strong></Term>
