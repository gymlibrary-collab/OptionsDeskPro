...
('put_broken_wing_butterfly',    'Put Broken Wing Butterfly',      'omnidirectional',  array['OMNIDIRECTIONAL'],                                           array['HIGH'],               15,   45,   60, 80, 'broken_wing_butterfly', 3, null),
('call_broken_wing_butterfly',   'Call Broken Wing Butterfly',     'omnidirectional',  array['OMNIDIRECTIONAL'],                                           array['HIGH'],               15,   45,   60, 80, 'broken_wing_butterfly', 3, null),
