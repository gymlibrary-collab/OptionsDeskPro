...
# Full strategy catalog — 19 core strategies (subset of the 31 in the tastylive guide)
STRATEGIES = {
    # Bullish
    "covered_call": {
        "name": "Covered Call",
    ...
    "put_broken_wing_butterfly": {
        ...
        "direction": ["NEUTRAL", "NEUTRAL_BULLISH"],
        "iv_environment": ["HIGH"],
        "risk_type": "DEFINED",
        "complexity": 3,
        "dte_target": 30,
    ...
    "call_broken_wing_butterfly": {
        ...
        "direction": ["NEUTRAL", "NEUTRAL_BEARISH"],
        "iv_environment": ["HIGH"],
        "risk_type": "DEFINED",
        "complexity": 3,
        "dte_target": 30,
...
def build_trade(symbol: str, strategy_key: str, options_chain: dict, spot_price: float) -> dict:
    ...
    if strategy_key == "covered_call":
        ...
        otm2 = make_leg("Short Call (OTM) 2", "call", 0.30, "sell")
